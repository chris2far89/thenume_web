...
export default function FungalTreatmentPage() {
  const fungalService = services.filter(s => s.id === 'nail-fungus')
      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-28">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <p className="font-[var(--font-body)] text-base md:text-lg text-muted-foreground font-light leading-relaxed max-w-2xl">
            Advanced plasma treatment to eliminate nail fungus safely and effectively.
          </p>
        </div>
      </section>
      ...
      <section className="pb-32 md:pb-40">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="space-y-32 md:space-y-40">
            {fungalService.map((service, index) => (
